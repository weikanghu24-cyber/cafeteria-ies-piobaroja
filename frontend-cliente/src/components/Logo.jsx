...
/**
 * Logo de la cafeteria IES Pio Baroja.
 * Combina: una taza estilizada + las palabras CAFETERIA y PIO BAROJA con tipografia mixta.
 */
  ...
  return (
    <div className={cn('flex items-center gap-3', className)}>
      ...
      <div className="flex flex-col leading-none">
        ...
        <span className="font-body text-[10px] font-bold uppercase tracking-[0.18em] text-accent">
          IES Pío Baroja
        </span>
      </div>
    </div>
